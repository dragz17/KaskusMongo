...
mongodb142=`ping -c 1 ${MONGO132} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
...
mongodb371=`ping -c 1 ${MONGO371} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb372=`ping -c 1 ${MONGO372} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb373=`ping -c 1 ${MONGO373} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb381=`ping -c 1 ${MONGO381} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb382=`ping -c 1 ${MONGO382} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb383=`ping -c 1 ${MONGO383} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb391=`ping -c 1 ${MONGO391} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb392=`ping -c 1 ${MONGO392} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb393=`ping -c 1 ${MONGO393} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb401=`ping -c 1 ${MONGO401} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb402=`ping -c 1 ${MONGO402} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb403=`ping -c 1 ${MONGO403} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb411=`ping -c 1 ${MONGO411} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb412=`ping -c 1 ${MONGO412} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb413=`ping -c 1 ${MONGO413} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb421=`ping -c 1 ${MONGO421} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb422=`ping -c 1 ${MONGO422} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb423=`ping -c 1 ${MONGO423} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb431=`ping -c 1 ${MONGO431} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb432=`ping -c 1 ${MONGO432} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb433=`ping -c 1 ${MONGO433} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb441=`ping -c 1 ${MONGO441} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb442=`ping -c 1 ${MONGO442} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb443=`ping -c 1 ${MONGO443} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb451=`ping -c 1 ${MONGO451} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb452=`ping -c 1 ${MONGO452} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb453=`ping -c 1 ${MONGO453} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb461=`ping -c 1 ${MONGO461} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb462=`ping -c 1 ${MONGO462} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb463=`ping -c 1 ${MONGO463} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb471=`ping -c 1 ${MONGO471} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb472=`ping -c 1 ${MONGO472} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb473=`ping -c 1 ${MONGO473} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb481=`ping -c 1 ${MONGO481} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb482=`ping -c 1 ${MONGO482} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb483=`ping -c 1 ${MONGO483} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`

mongodb491=`ping -c 1 ${MONGO491} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb492=`ping -c 1 ${MONGO492} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
mongodb493=`ping -c 1 ${MONGO493} | head -1  | cut -d "(" -f 2 | cut -d ")" -f 1`
...
mongo --host ${mongodb1}:${port} <<EOF
   ...
   sh.addShard( "${RS37}/${mongodb371}:${PORT1},${mongodb372}:${PORT2},${mongodb373}:${PORT3}" );
   sh.addShard( "${RS38}/${mongodb381}:${PORT1},${mongodb382}:${PORT2},${mongodb383}:${PORT3}" );
   sh.addShard( "${RS39}/${mongodb391}:${PORT1},${mongodb392}:${PORT2},${mongodb393}:${PORT3}" );
   sh.addShard( "${RS40}/${mongodb401}:${PORT1},${mongodb402}:${PORT2},${mongodb403}:${PORT3}" );
   sh.addShard( "${RS41}/${mongodb411}:${PORT1},${mongodb412}:${PORT2},${mongodb413}:${PORT3}" );
   sh.addShard( "${RS42}/${mongodb421}:${PORT1},${mongodb422}:${PORT2},${mongodb423}:${PORT3}" );
   sh.addShard( "${RS43}/${mongodb431}:${PORT1},${mongodb432}:${PORT2},${mongodb433}:${PORT3}" );
   sh.addShard( "${RS44}/${mongodb441}:${PORT1},${mongodb442}:${PORT2},${mongodb443}:${PORT3}" );
   sh.addShard( "${RS45}/${mongodb451}:${PORT1},${mongodb452}:${PORT2},${mongodb453}:${PORT3}" );
   sh.addShard( "${RS46}/${mongodb461}:${PORT1},${mongodb462}:${PORT2},${mongodb463}:${PORT3}" );
   sh.addShard( "${RS47}/${mongodb471}:${PORT1},${mongodb472}:${PORT2},${mongodb473}:${PORT3}" );
   sh.addShard( "${RS48}/${mongodb481}:${PORT1},${mongodb482}:${PORT2},${mongodb483}:${PORT3}" );
   sh.addShard( "${RS49}/${mongodb491}:${PORT1},${mongodb492}:${PORT2},${mongodb493}:${PORT3}" );
